...
```
quick-data-cli/
├── .cli.json                      # Ready-to-use CLI client configuration
...
├── src/cli_server/               # Core server implementation
...
# → Returns: {"name": "Generic Data Analytics CLI", "features": [...]}
...
- ✅ **Universal CLI Client Compatibility** - Supports both resource-enabled and tool-only clients
